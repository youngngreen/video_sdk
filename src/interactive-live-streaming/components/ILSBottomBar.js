...
export function ILSBottomBar({
  ...
  const ProductBTN = () => {
    ...
    return (
      <button class="bg-red-500 text-white p-2 rounded text-sm w-auto"
      onClick={() => {
        setSideBarMode((s) =>
  ...
  const GetVoucherBTN = () => {
    ...
    return (
      <button class="bg-yellow-500 text-white p-2 rounded text-sm w-auto mr-2"
      onClick={() => {
        setSideBarMode((s) =>
          s === sideBarModes.VOUCHER ? null : sideBarModes.VOUCHER
        );
      }}
      >
        Voucher</button>
  ...
  const FollowBTN = () => {
    ...
    return (
      <button class="bg-blue-500 text-white p-2 rounded text-sm w-auto mr-2"
      >
        Follow</button>
    );
  };
  ...
  const ShareBTN = () => {
    ...
    return (
      <button class="bg-blue-600 text-white p-2 rounded text-sm w-auto mr-2"
      onClick={() => {
        setSideBarMode((s) =>
          s === sideBarModes.SHARE ? null : sideBarModes.SHARE
        );
      }}
      >
        Share</button>
  ...
  return isMobile || isTab ? (
    ...
    <div className="md:flex lg:px-2 xl:px-6 pb-2 px-2 hidden">
      {meetingMode === Constants.modes.CONFERENCE && <MeetingIdCopyBTN />}
      <div className="flex items-center justify-center">
        {meetingMode === Constants.modes.VIEWER && <ViewBTN/>}
        {meetingMode === Constants.modes.VIEWER && <p className="text-red-500 mr-2">SALE 50% OFF TODAY!!!</p>}
        {meetingMode === Constants.modes.VIEWER && <a href="#" className="text-blue-500 mr-2">Dadies fashion shop</a>}
        {meetingMode === Constants.modes.VIEWER && <FollowBTN/>}
        {meetingMode === Constants.modes.VIEWER && <ShareBTN/>}
      </div>
      <div className="flex flex-1 items-center justify-center" ref={tollTipEl}>
        ...
        {meetingMode === Constants.modes.VIEWER && <ViewerLeaveBTN/>}
        {meetingMode === Constants.modes.CONFERENCE && <LeaveBTN />}
        
      </div>
      <div className="flex items-center justify-center">
        {meetingMode === Constants.modes.VIEWER && <GetVoucherBTN/>}
        {meetingMode === Constants.modes.VIEWER && <ProductBTN/>}
        {/* {meetingMode === Constants.modes.VIEWER && (
          <ECommerceBTN isMobile={isMobile} isTab={isTab} />
        )} */}
        {/* <PollBTN isMobile={isMobile} isTab={isTab} /> */}
